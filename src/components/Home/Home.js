...
const Home = () => {
    return (
        <div className='flex rounded-md pb-4'>
            ...
            <h1 className='mt-12 text-center text-amber-700 text-4xl font-mono font-semibold italic hover:not-italic'>Brain <br />
            ...
            <button className='mt-3 bg-amber-600 text-white text-mono px-4 py-1 rounded-md'>Take a Quiz</button>
            </div>
            </div>
            <div className='bg-stone-800'>
